...
export default function SignInForm({ onSwitchToSignUp }: { onSwitchToSignUp: () => void }) {
  ...
  return (
    <div className="mx-auto w-full mt-10 max-w-md p-6">
      <h1 className="font-display text-3xl font-medium text-center mb-2">Welcome back</h1>
      <p className="text-muted-foreground text-center mb-8">Sign in to your Exhibit account</p>
